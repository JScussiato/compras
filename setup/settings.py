# setup / setting.py
""" Django settings for setup project. Generated by 'django-admin startproject' using Django 4.2.7.
...
# input("Estou em setup / settings.py")
...
INSTALLED_APPS = [
    ...
    "apps.lcompras.apps.LcomprasConfig",
